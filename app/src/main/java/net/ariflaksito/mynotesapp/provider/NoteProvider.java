package net.ariflaksito.mynotesapp.provider;
...
import net.ariflaksito.mynotesapp.db.DatabaseContract;
import net.ariflaksito.mynotesapp.db.NoteHelper;

import static net.ariflaksito.mynotesapp.db.DatabaseContract.AUTHORITY;
