package net.ariflaksito.mynotesapp.adapter;
...
import net.ariflaksito.mynotesapp.CustomOnItemClickListener;
import net.ariflaksito.mynotesapp.FormAddUpdateActivity;
import net.ariflaksito.mynotesapp.R;
