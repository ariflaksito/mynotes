...
import net.ariflaksito.mynotesapp.adapter.NoteAdapter;
...
import static net.ariflaksito.mynotesapp.FormAddUpdateActivity.REQUEST_UPDATE;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setListNotes(listCursor);
