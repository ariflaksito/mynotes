package net.ariflaksito.mynewnotes;
...
import net.ariflaksito.mynewnotes.entity.NoteItem;

import java.text.DateFormat;
import java.text.SimpleDateFormat;
import java.util.Date;

import static net.ariflaksito.mynewnotes.db.DatabaseContract.CONTENT_URI;
