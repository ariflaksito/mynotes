package net.ariflaksito.mynewnotes.entity;

import android.database.Cursor;
import android.os.Parcel;
import android.os.Parcelable;

import net.ariflaksito.mynewnotes.db.DatabaseContract;

import static net.ariflaksito.mynewnotes.db.DatabaseContract.getColumnInt;
